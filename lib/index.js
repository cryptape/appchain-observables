...
const plugin_1 = __importStar(require("@nervos/plugin"));
class NervosObservables {
    constructor({ server, interval = 1000, reservedRecords = 10, }) {
        ...
        this.getTransactionReceipt = (hash) => rxjs_1.Observable.fromPromise(this.NervosWeb3.getTransactionReceipt(hash));
        ...
        this.metaData = ({ blockNumber = 'latest' }) => rxjs_1.Observable.fromPromise(this.NervosWeb3.metadata({ blockNumber: blockNumber }));
        ...
        this.getQuotaPrice = (blockNumber = 'latest') => rxjs_1.Observable.fromPromise(this.NervosWeb3.getQuotaPrice(blockNumber));
